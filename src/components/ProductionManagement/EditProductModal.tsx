    ...
    <div className="my-4">
      <div className="flex flex-wrap gap-3 mb-4">
        {[allergens]?.map((allergen) => (
          <div key={allergen?.allergies} className="relative group">
            <button
              type="button"
              onClick={() => toggleAllergen(allergen.allergies)}
            ...
            {allergen.allergies && (
              <button
                type="button"
                aria-label={`Remove ${allergen.allergies}`}
                onClick={(e) => {
                  e.stopPropagation();
                  removeAllergen(allergen.allergies);
                }}
